...
class _StaffDashboardHomeContentState extends State<_StaffDashboardHomeContent>
        ...
        return RefreshIndicator(
          ...
          child: NestedScrollView(
            ...
            body: TabBarView(
              ...
              children: [
                _buildPendingLeavesTab(managerViewModel.pendingLeaves),
                _buildApprovedLeavesTab(managerViewModel),
              ],
            ),
          ),
        );
  ...
  Widget _buildStaffTabBarHeader(ManagerDashboardViewModel viewModel) {
    return Container(
...
class _StaffTabBarDelegate extends SliverPersistentHeaderDelegate {
  final Widget child;
  final double height;

  _StaffTabBarDelegate({required this.child, required this.height});
